...
def train(rank=0, args=None, temp_dir=""):
    ...
    gettr = partial(get_param, configs_1=meta_config.get("train", {}), configs_2=args)
    train_config = ConfigDict(**{
        k: gettr(k) 
        for k in (
            "batch_size", "beta1", "beta2", "lr", "epochs", "grad_norm", "warmup",
            "chkpt_intv", "image_intv", "use_ema", "ema_decay")})
    ...
    getdif = partial(get_param, configs_1=meta_config.get("diffusion", {}), configs_2=args)
...
def main():
    ...
    parser.add_argument("--dataset", choices=["mnist", "cifar10", "cifar100", "celeba", "celebahq"], default="cifar10")
    parser.add_argument("--root", default="/root/localdisk/lsy/ddpm-torch-new-train/datasets", type=str, help="root directory of datasets")
    parser.add_argument("--epochs", default=5000, type=int, help="total number of training epochs")
    ...
    parser.add_argument("--image-dir", default="./images/label_train", type=str)
    parser.add_argument("--image-intv", default=1, type=int)
    parser.add_argument("--config-dir", default="/root/localdisk/lsy/ddpm-torch-new-train/configs", type=str)
    parser.add_argument("--chkpt-dir", default="/root/localdisk/lsy/ddpm-torch-new-train/chkpts/convcifar10", type=str)
